# Emergency Close Panel Blueprint

## 1. Tool identity
- **Name:** Emergency Close Panel
- **Suite:** Execution Suite
- **Public tier vs private tier:** Public = Basic buttons; Private = Conditional logic
- **Status (Idea/Planned/In Build/Released):** Planned

## 2. User-facing definition
- **Problem statement:** Close trades fast with predictable behavior that reduces manual errors.
- **Target user:** Retail and prop traders.
- **Primary use cases:** Use Emergency Close Panel to adjust SL/TP logic quickly after entry while preserving predefined risk rules.
...
- **Core logic rules:** Deterministic rule evaluation; public logic follows **Basic buttons** behavior, while private roadmap variant extends to **Conditional logic**.
...
## 4. UX specification
- **Panel layout:** Header (status + symbol/account), central control group for close trades fast, footer with recent actions/log snippets.
...
## 8. Release metadata
- **Version:** 0.1.0-emergency-close-panel
