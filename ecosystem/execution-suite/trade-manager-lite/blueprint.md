# Trade Manager Lite Blueprint

## 1. Tool identity
- **Name:** Trade Manager Lite
- **Suite:** Execution Suite
- **Public tier vs private tier:** Public = Manual controls; Private = Context-aware
- **Status (Idea/Planned/In Build/Released):** In Build

## 2. User-facing definition
- **Problem statement:** Manage trades with predictable behavior that reduces manual errors.
- **Target user:** Retail and prop traders.
- **Primary use cases:** Use Trade Manager Lite to adjust SL/TP logic quickly after entry while preserving predefined risk rules.
...
- **Core logic rules:** Deterministic rule evaluation; public logic follows **Manual controls** behavior, while private roadmap variant extends to **Context-aware**.
...
## 4. UX specification
- **Panel layout:** Header (status + symbol/account), central control group for manage trades, footer with recent actions/log snippets.
...
## 8. Release metadata
- **Version:** 0.1.0-trade-manager-lite
