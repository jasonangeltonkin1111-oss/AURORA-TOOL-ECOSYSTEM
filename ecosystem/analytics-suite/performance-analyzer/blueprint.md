# Performance Analyzer Blueprint

## 1. Tool identity
- **Name:** Performance Analyzer
- **Suite:** Analytics Suite
- **Public tier vs private tier:** Public = Basic stats; Private = Deep analytics
- **Status (Idea/Planned/In Build/Released):** Planned

## 2. User-facing definition
- **Problem statement:** Stats breakdown with predictable behavior that reduces manual errors.
- **Target user:** Retail and prop traders.
- **Primary use cases:** Use Performance Analyzer to export and analyze trading history for review and iteration.
...
- **Core logic rules:** Deterministic rule evaluation; public logic follows **Basic stats** behavior, while private roadmap variant extends to **Deep analytics**.
...
## 4. UX specification
- **Panel layout:** Header (status + symbol/account), central control group for stats breakdown, footer with recent actions/log snippets.
...
## 8. Release metadata
- **Version:** 0.1.0-performance-analyzer
