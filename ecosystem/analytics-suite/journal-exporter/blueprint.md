# Journal Exporter Blueprint

## 1. Tool identity
- **Name:** Journal Exporter
- **Suite:** Analytics Suite
- **Public tier vs private tier:** Public = CSV export; Private = Enriched data
- **Status (Idea/Planned/In Build/Released):** In Build

## 2. User-facing definition
- **Problem statement:** Export trades with predictable behavior that reduces manual errors.
- **Target user:** Retail and prop traders.
- **Primary use cases:** Use Journal Exporter to export and analyze trading history for review and iteration.
...
- **Core logic rules:** Deterministic rule evaluation; public logic follows **CSV export** behavior, while private roadmap variant extends to **Enriched data**.
...
## 4. UX specification
- **Panel layout:** Header (status + symbol/account), central control group for export trades, footer with recent actions/log snippets.
...
## 8. Release metadata
- **Version:** 0.1.0-journal-exporter
