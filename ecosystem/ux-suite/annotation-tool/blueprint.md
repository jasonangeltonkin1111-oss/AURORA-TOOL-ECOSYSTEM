# Annotation Tool Blueprint

## 1. Tool identity
- **Name:** Annotation Tool
- **Suite:** Ux Suite
- **Public tier vs private tier:** Public = Manual notes; Private = Linked journaling
- **Status (Idea/Planned/In Build/Released):** Planned

## 2. User-facing definition
- **Problem statement:** Mark charts with predictable behavior that reduces manual errors.
- **Target user:** Traders optimizing chart readability.
- **Primary use cases:** Use Annotation Tool to improve information clarity and speed of chart interpretation.
...
- **Core logic rules:** Deterministic rule evaluation; public logic follows **Manual notes** behavior, while private roadmap variant extends to **Linked journaling**.
...
## 4. UX specification
- **Panel layout:** Header (status + symbol/account), central control group for mark charts, footer with recent actions/log snippets.
