# Partial Close Tool Blueprint

## 1. Tool identity
- **Name:** Partial Close Tool
- **Suite:** Execution Suite
- **Public tier vs private tier:** Public = Fixed levels; Private = Dynamic distribution
- **Status (Idea/Planned/In Build/Released):** Planned

## 2. User-facing definition
- **Problem statement:** Close portions with predictable behavior that reduces manual errors.
- **Target user:** Retail and prop traders.
- **Primary use cases:** Use Partial Close Tool to adjust SL/TP logic quickly after entry while preserving predefined risk rules.
...
- **Core logic rules:** Deterministic rule evaluation; public logic follows **Fixed levels** behavior, while private roadmap variant extends to **Dynamic distribution**.
...
## 4. UX specification
- **Panel layout:** Header (status + symbol/account), central control group for close portions, footer with recent actions/log snippets.
...
## 8. Release metadata
- **Version:** 0.1.0-partial-close-tool
