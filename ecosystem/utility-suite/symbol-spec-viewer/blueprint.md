# Symbol Spec Viewer Blueprint

## 1. Tool identity
- **Name:** Symbol Spec Viewer
- **Suite:** Utility Suite
- **Public tier vs private tier:** Public = Static info; Private = Normalized engine
- **Status (Idea/Planned/In Build/Released):** Planned

## 2. User-facing definition
- **Problem statement:** Broker specs with predictable behavior that reduces manual errors.
- **Target user:** Retail and prop traders.
- **Primary use cases:** Use Symbol Spec Viewer to provide broker/account utilities needed by other tools.
...
- **Core logic rules:** Deterministic rule evaluation; public logic follows **Static info** behavior, while private roadmap variant extends to **Normalized engine**.
...
## 4. UX specification
- **Panel layout:** Header (status + symbol/account), central control group for broker specs, footer with recent actions/log snippets.
...
## 8. Release metadata
- **Version:** 0.1.0-symbol-spec-viewer
