# Margin Calculator Blueprint

## 1. Tool identity
- **Name:** Margin Calculator
- **Suite:** Utility Suite
- **Public tier vs private tier:** Public = Simple calc; Private = Portfolio-aware
- **Status (Idea/Planned/In Build/Released):** Planned

## 2. User-facing definition
- **Problem statement:** Margin estimate with predictable behavior that reduces manual errors.
- **Target user:** Retail and prop traders.
- **Primary use cases:** Use Margin Calculator to provide broker/account utilities needed by other tools.
...
- **Core logic rules:** Deterministic rule evaluation; public logic follows **Simple calc** behavior, while private roadmap variant extends to **Portfolio-aware**.
...
## 4. UX specification
- **Panel layout:** Header (status + symbol/account), central control group for margin estimate, footer with recent actions/log snippets.
...
## 8. Release metadata
- **Version:** 0.1.0-margin-calculator
