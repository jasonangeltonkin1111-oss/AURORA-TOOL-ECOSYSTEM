# Scanner Lite Blueprint

## 1. Tool identity
- **Name:** Scanner Lite
- **Suite:** Execution Suite
- **Public tier vs private tier:** Public = Simple filters; Private = Full intelligence
- **Status (Idea/Planned/In Build/Released):** Planned

## 2. User-facing definition
- **Problem statement:** Basic scanning with predictable behavior that reduces manual errors.
- **Target user:** Retail and prop traders.
- **Primary use cases:** Use Scanner Lite to surface trade candidates that meet predefined volatility/filter profiles.
...
- **Core logic rules:** Deterministic rule evaluation; public logic follows **Simple filters** behavior, while private roadmap variant extends to **Full intelligence**.
...
## 4. UX specification
- **Panel layout:** Header (status + symbol/account), central control group for basic scanning, footer with recent actions/log snippets.
