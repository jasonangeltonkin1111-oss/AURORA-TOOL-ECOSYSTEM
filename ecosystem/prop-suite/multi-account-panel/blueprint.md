# Multi Account Panel Blueprint

## 1. Tool identity
- **Name:** Multi Account Panel
- **Suite:** Prop Suite
- **Public tier vs private tier:** Public = Manual tracking; Private = Fleet management
- **Status (Idea/Planned/In Build/Released):** Planned

## 2. User-facing definition
- **Problem statement:** Track accounts with predictable behavior that reduces manual errors.
- **Target user:** Retail and prop traders.
- **Primary use cases:** Use Multi Account Panel to avoid challenge/account rule breaches and track progress requirements.
...
- **Core logic rules:** Deterministic rule evaluation; public logic follows **Manual tracking** behavior, while private roadmap variant extends to **Fleet management**.
...
## 4. UX specification
- **Panel layout:** Header (status + symbol/account), central control group for track accounts, footer with recent actions/log snippets.
...
## 8. Release metadata
- **Version:** 0.1.0-multi-account-panel
