# Volatility Scanner Blueprint

## 1. Tool identity
- **Name:** Volatility Scanner
- **Suite:** Execution Suite
- **Public tier vs private tier:** Public = ATR-based; Private = Regime detection
- **Status (Idea/Planned/In Build/Released):** Planned

## 2. User-facing definition
- **Problem statement:** Find movement with predictable behavior that reduces manual errors.
- **Target user:** Retail and prop traders.
- **Primary use cases:** Use Volatility Scanner to surface trade candidates that meet predefined volatility/filter profiles.
...
- **Core logic rules:** Deterministic rule evaluation; public logic follows **ATR-based** behavior, while private roadmap variant extends to **Regime detection**.
...
## 4. UX specification
- **Panel layout:** Header (status + symbol/account), central control group for find movement, footer with recent actions/log snippets.
...
## 8. Release metadata
- **Version:** 0.1.0-volatility-scanner
